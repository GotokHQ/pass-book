...
impl TestEditionMarker {
    pub fn new(metadata: &TestMetadata, master_edition: &TestMasterEditionV2, edition: u64) -> Self {
        ...
        let (new_edition_pubkey, _) = Pubkey::find_program_address(edition_seeds, &id());
    ...
    pub async fn create(&self, context: &mut ProgramTestContext, token_authority: &Pubkey) -> transport::Result<()> {
